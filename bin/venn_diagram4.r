venn_diagram4 <- function(a, b, c, d, name_a = "A", name_b = "B", name_c = "C", name_d = "D", colors =  c("#542BFD","#FCFF4F","#5CFF4A", "#F63C4B"), name_output = "default.pdf", euler=FALSE, special=TRUE){
	# Niels Hanson
